...
return (
  <div className="dashboard">
    ...
    <DepositModal
      show={showDepositInfo}
      setShowDepositInfo={setShowDepositInfo}
      trader={profile?.assignedTrader}
    />
      ...
      >
        ...
        <div style={styles.panel}>
          ...
          <div style={styles.statCard}>
            <span>
              {isLiveMode ? t("liveBalance") : t("demoBalance")}
            </span>
        ...
        >
          ...
          >
            ...
            {t(`cardServices.${cardStatus || "notApplied"}`)}
          </div>
